...
# Desc: Script CDInventory to store CD Inventory data (using Classes and Functions)
# Change Log: (Who, When, What) 
# DBiesinger, 2030-Jan-01, Created File #
# MYokus, 2021-Aug-15, Added Code 
#------------------------------------------#
...
class FileProcessor:
    ...
    def write_file(file_name, table):
        """Function to save a 2D table (a list of dictionaries) to file

        Saves the data in a file identified by file_name into a .txt file
        ...
        for row in table:
            lstValues = list(row.values()) # Converts dictionary row values to a list 
            lstValues[0] = str(lstValues[0]) # Converts the data type from int to str
...
while True:
    ...
    # 3.3 process add a CD
        ...
        DataProcessor.add_table(inputs_list, lstTbl)
        IO.show_inventory(lstTbl)
        continue  # start loop back at top.
